...
public class OneNoteAndTaxi extends SequentialCommandGroup {
	public OneNoteAndTaxi(SwerveDrive swerve, Shooter shooter, ArmRS arm, Indexer indexer, Intake intake,
			REVBlinkin lights) {
		Pose2d startPose = new Pose2d(0.73, 4.47, Rotation2d.fromDegrees(-59.86));
		Command paths = Commands.sequence(swerve.resetOdometryCmd(startPose), new IntakeNote(intake, indexer, lights),
