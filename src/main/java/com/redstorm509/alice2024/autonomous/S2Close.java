...
public class S2Close extends SequentialCommandGroup {
	public S2Close(SwerveDrive swerve, Shooter shooter, Arm arm, Indexer indexer, Intake intake, REVBlinkin lights) {
